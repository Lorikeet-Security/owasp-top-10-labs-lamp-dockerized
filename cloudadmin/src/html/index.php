...
$ip_address_from_machine = exec("ip addr show tun0 | grep 'inet ' | awk '{print $2}' | cut -d/ -f1");

if ($_SERVER['HTTP_HOST'] === $ip_address_from_machine) {
    // Redirect to the domain
    header('Location: http://cloudadminhosting.com');
    exit;
}
...
<head>
  ...
  <title>Alex Smith - Cloud Admin </title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="https://s3.cloudadminhosting.com/portfolio_pictures/my-profile-img.jpg" rel="icon">
  <link href="https://s3.cloudadminhosting.com/portfolio_pictures/my-profile-img.jpg" rel="apple-touch-icon">
