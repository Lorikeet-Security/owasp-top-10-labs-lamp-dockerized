    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-6">
                <h2><?php echo __('infoAddLineTitle', true);?></h2>
            </div>
        ...
        <p class="m-b-none"><i class="fa fa-info-circle"></i> <?php echo __('infoAddLineDesc', true); ?></p>
    </div>
</div>
...
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminLines&amp;action=pjActionCreate" method="post" id="frmCreateLine" class="form pj-form" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
								...
								foreach ($tpl['lp_arr'] as $v)
								{
									...
									<div class="<?php echo $tpl['is_flag_ready'] ? 'input-group ' : NULL;?>pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 1 ? NULL : 'none'; ?>">
										<input type="text" class="form-control<?php echo (int) $v['is_default'] === 0 ? NULL : ' required'; ?>" name="i18n[<?php echo $v['id']; ?>][title]" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">	
										<?php if ($tpl['is_flag_ready']) : ?>
                    ...
                    <div class="row">
                    	<div class="col-lg-3 col-md-3 col-sm-6">
                            <div class="form-group">
								...
								<input type="text" name="seats" id="seats" class="form-control field-int required" data-msg-required="<?php __('plugin_base_this_field_is_required'); ?>"/>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6">
                        	<div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                        	<div class="form-group">
								...
								foreach ($tpl['lp_arr'] as $v)
								{
									?>
									<div class="<?php echo $tpl['is_flag_ready'] ? 'input-group ' : NULL;?>pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 1 ? NULL : 'none'; ?>">
										<textarea name="i18n[<?php echo $v['id']; ?>][description]" rows="4" class="form-control" lang="<?php echo $v['id']; ?>" ></textarea>	
										<?php if ($tpl['is_flag_ready']) : ?>
										<span class="input-group-addon pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="<?php echo pjSanitize::html($v['name']); ?>"></span>
										<?php endif; ?>
									</div>
