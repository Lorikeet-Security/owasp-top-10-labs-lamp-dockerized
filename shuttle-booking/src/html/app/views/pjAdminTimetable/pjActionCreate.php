    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-6">
                <h2><?php echo __('infoAddTimetableTitle', true);?></h2>
            </div>
        </div>

        <p class="m-b-none"><i class="fa fa-info-circle"></i> <?php echo __('infoAddTimetableDesc', true); ?></p>
    </div>
</div>
...
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminTimetable&amp;action=pjActionCreate" method="post" id="frmCreateTimetable" class="form pj-form" autocomplete="off" enctype="multipart/form-data">
				<input type="hidden" name="timetable_create" value="1" />
            	<div class="ibox-content">
                            ...
                            <div id="pjLineWrapper" class="form-group">
								...
								<div class="form-horizontal">
									<label class="normal-label m-t-xs">
                                    	<input type="radio" name="direction" id="direcion_arriving" value="arriving" checked="checked" class="m-r-xs i-checks pps"/> <span class="m-l-xs"><?php __('lblArriving');?></span>
                                    </label>
    								<label class="normal-label m-t-xs">
                                    	<input type="radio" name="direction" id="direcion_departing" value="departing" class="m-r-xs i-checks pps"/> <span class="m-l-xs"><?php __('lblDeparting');?></span>
                                    </label>
                        	...
                        	<div class="form-group">
								...
								<div class="form-horizontal">
									...
									{ 
									    ?>
									    <label class="normal-label m-t-xs">
                                        	<input type="checkbox" name="every[]" id="every_<?php echo $k?>" value="<?php echo $k?>" class="i-checks"/> <span class="m-l-xs"><?php echo $v;?></span>
                                        </label>
									    <?php
									}
									?>
					...
					<?php $index = 'new_' . rand(1, 999999);?>
					<div class="hr-line-dashed"></div>
						<div class="row">
    						<div class="col-lg-12 col-md-12 col-sm-12">
                            	<div class="form-group">
                                    <label class="control-label pjTimeLabel pjTimeLabel-arriving"><?php __('lblArrivingAt');?></label>
                                    <label class="control-label pjTimeLabel pjTimeLabel-departing" style="display:none;"><?php __('lblDepartingAt');?></label>
    								<div id="pjTimeWrapper" class="form-horizontal">
    									<div class="pjTimeCell">
        									<div class="input-group clockpicker">
                                                <input type="text" id="time_<?php echo $index;?>" name="time[<?php echo $index;?>]" class="form-control required" readonly data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>"/>
