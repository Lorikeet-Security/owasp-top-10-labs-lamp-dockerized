...
<div class="form-group hidden-area live-area" style="display: <?php echo $is_active && !$is_test_mode ? 'block' : 'none'; ?>">
    ...
    <div class="col-lg-8">
        <div class="input-group">
            ...
            <input type="text" name="plugin_payment_options[paypal][merchant_email]" value="<?php echo pjSanitize::html(@$tpl['arr']['merchant_email']); ?>" class="form-control required" maxlength="255">
        </div>
...
<div class="form-group hidden-area test-area" style="display: <?php echo $is_active && $is_test_mode ? 'block' : 'none'; ?>">
    ...
    <div class="col-lg-8">
        <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-at"></i></span>
            <input type="text" name="plugin_payment_options[paypal][test_merchant_email]" value="<?php echo pjSanitize::html(@$tpl['arr']['test_merchant_email']); ?>" class="form-control required" maxlength="255">
        </div>
        <p class="small"><?php __('plugin_paypal_merchant_email_text'); ?></p>
    </div>
</div>